...
var MangementTeam = keystone.list('MangementTeam');
...
exports = module.exports = function(req, res) {
	...
	// Init locals
		locals.section = 'mangementteam';
		locals.data = [];

	// Load the current MangementTeam
	view.on('init', function(next) {
		var q = MangementTeam.model.find();
		q.exec(function(err, results) {
			locals.data.mangementteams = results;
			next(err);
		});
	});
