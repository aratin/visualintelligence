...
var Allnewes = keystone.list('Allnewes');
...
exports = module.exports = function(req, res) {
	...
	// Init locals
		locals.section = 'allnewes';
		locals.data = [];

	// Load the current Allnewes
	view.on('init', function(next) {
		var q = Allnewes.model.find();
		q.exec(function(err, results) {
			locals.data.allnewess = results;
			next(err);
		});
	});
